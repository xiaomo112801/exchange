...
const allRecords = ref<TransferRecord[]>([
  {
    id: 1,
    coinCode: 'USDT',
    coinName: 'Tether',
    ...
    completeTime: '2024-12-24 10:30:05',
  },
  {
    id: 2,
    coinCode: 'BTC',
  ...
  },
  {
    ...
    amount: '50.00',
    amountCny: '¥350.00',
    fromAccount: '合约(交割)账户',
    toAccount: '现货账户',
    status: 'completed',
    createTime: '2024-12-23 16:45:00',
    completeTime: '2024-12-23 16:45:03',
  },
])
...
<template>
  <view class="transfer-record-page min-h-screen flex flex-col bg-white">
    <!-- 顶部导航栏 -->
    <wd-navbar
      safe-area-inset-top
      placeholder
    ...
    <view class="flex flex-1 flex-col px-4 pb-3 pt-3">
          ...
          <view class="flex items-center justify-between">
            <view class="flex items-center gap-2">
              ...
              <view class="flex flex-col">
                ...
                <wd-text :text="record.coinName" size="0.75rem" color="#999" />
              </view>
            </view>
            <view
          ...
          <view class="flex items-center justify-between border-t border-gray-100 pt-2">
            <view class="flex flex-col">
              <view class="flex items-center gap-1">
                ...
                <wd-text text="从" size="0.75rem" color="#666" />
                <wd-text :text="record.fromAccount" size="0.75rem" color="#000" />
              </view>
              <view class="mt-1 flex items-center gap-1">
                <view class="h-1.5 w-1.5 rounded-full bg-black" />
                <wd-text text="到" size="0.75rem" color="#666" />
                <wd-text :text="record.toAccount" size="0.75rem" color="#000" />
              </view>
            </view>
      ...
      <view v-else class="flex flex-1 items-center justify-center">
        <view class="flex flex-col items-center gap-2">
          ...
          <wd-text text="暂无划转记录" size="0.875rem" color="#999" />
        </view>
      </view>
    </view>
  </view>
